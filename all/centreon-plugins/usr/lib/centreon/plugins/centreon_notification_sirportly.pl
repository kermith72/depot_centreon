...
$fatpacked{"notification/sirportly/mode/ticket.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NOTIFICATION_SIRPORTLY_MODE_TICKET';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"notification/sirportly/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NOTIFICATION_SIRPORTLY_PLUGIN';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
