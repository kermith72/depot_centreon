...
$fatpacked{"notification/prowl/mode/alert.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NOTIFICATION_PROWL_MODE_ALERT';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"notification/prowl/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'NOTIFICATION_PROWL_PLUGIN';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
