...
$fatpacked{"hardware/devices/barco/cs/restapi/custom/api.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_DEVICES_BARCO_CS_RESTAPI_CUSTOM_API';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"hardware/devices/barco/cs/restapi/mode/device.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_DEVICES_BARCO_CS_RESTAPI_MODE_DEVICE';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"hardware/devices/barco/cs/restapi/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_DEVICES_BARCO_CS_RESTAPI_PLUGIN';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
