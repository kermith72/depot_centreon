...
$fatpacked{"apps/nmap/cli/mode/discovery.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_NMAP_CLI_MODE_DISCOVERY';
  #
...
$fatpacked{"apps/nmap/cli/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_NMAP_CLI_PLUGIN';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
