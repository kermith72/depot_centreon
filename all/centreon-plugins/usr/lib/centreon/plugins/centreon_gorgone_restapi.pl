...
$fatpacked{"apps/gorgone/restapi/custom/api.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_GORGONE_RESTAPI_CUSTOM_API';
  #
...
$fatpacked{"apps/gorgone/restapi/mode/events.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_GORGONE_RESTAPI_MODE_EVENTS';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/gorgone/restapi/mode/nodes.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_GORGONE_RESTAPI_MODE_NODES';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/gorgone/restapi/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_GORGONE_RESTAPI_PLUGIN';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
