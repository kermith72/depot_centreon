...
$fatpacked{"apps/salesforce/restapi/custom/api.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_SALESFORCE_RESTAPI_CUSTOM_API';
  #
...
$fatpacked{"apps/salesforce/restapi/mode/sfdcinstance.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_SALESFORCE_RESTAPI_MODE_SFDCINSTANCE';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/salesforce/restapi/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_SALESFORCE_RESTAPI_PLUGIN';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
