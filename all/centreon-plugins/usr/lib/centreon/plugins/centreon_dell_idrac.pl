...
$fatpacked{"hardware/server/dell/idrac/snmp/mode/components/enclosure.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_SERVER_DELL_IDRAC_SNMP_MODE_COMPONENTS_ENCLOSURE';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
