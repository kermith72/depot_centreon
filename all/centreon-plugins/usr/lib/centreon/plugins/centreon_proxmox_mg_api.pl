...
$fatpacked{"apps/proxmox/mg/restapi/custom/api.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_PROXMOX_MG_RESTAPI_CUSTOM_API';
  #
...
$fatpacked{"apps/proxmox/mg/restapi/mode/mail.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_PROXMOX_MG_RESTAPI_MODE_MAIL';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/proxmox/mg/restapi/mode/version.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_PROXMOX_MG_RESTAPI_MODE_VERSION';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/proxmox/mg/restapi/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_PROXMOX_MG_RESTAPI_PLUGIN';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
