...
$fatpacked{"storage/emc/celerra/local/mode/filesystems.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'STORAGE_EMC_CELERRA_LOCAL_MODE_FILESYSTEMS';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"storage/emc/celerra/local/mode/pools.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'STORAGE_EMC_CELERRA_LOCAL_MODE_POOLS';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
