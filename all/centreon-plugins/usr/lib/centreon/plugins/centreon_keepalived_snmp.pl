...
$fatpacked{"apps/keepalived/snmp/mode/vrrpstatus.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_KEEPALIVED_SNMP_MODE_VRRPSTATUS';
  #
...
$fatpacked{"apps/keepalived/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_KEEPALIVED_SNMP_PLUGIN';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
