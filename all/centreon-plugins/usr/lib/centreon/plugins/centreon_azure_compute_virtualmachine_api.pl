...
$fatpacked{"cloud/azure/compute/virtualmachine/mode/discovery.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AZURE_COMPUTE_VIRTUALMACHINE_MODE_DISCOVERY';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/azure/compute/virtualmachine/mode/health.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_AZURE_COMPUTE_VIRTUALMACHINE_MODE_HEALTH';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
