...
$fatpacked{"apps/oracle/gg/local/custom/cli.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_ORACLE_GG_LOCAL_CUSTOM_CLI';
  #
...
$fatpacked{"apps/oracle/gg/local/mode/processes.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_ORACLE_GG_LOCAL_MODE_PROCESSES';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/oracle/gg/local/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_ORACLE_GG_LOCAL_PLUGIN';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
