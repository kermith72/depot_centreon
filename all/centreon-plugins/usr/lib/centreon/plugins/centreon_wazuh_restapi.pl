...
$fatpacked{"apps/wazuh/restapi/custom/api.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_WAZUH_RESTAPI_CUSTOM_API';
  #
...
$fatpacked{"apps/wazuh/restapi/mode/agents.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_WAZUH_RESTAPI_MODE_AGENTS';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/wazuh/restapi/mode/manager.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_WAZUH_RESTAPI_MODE_MANAGER';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/wazuh/restapi/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_WAZUH_RESTAPI_PLUGIN';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
