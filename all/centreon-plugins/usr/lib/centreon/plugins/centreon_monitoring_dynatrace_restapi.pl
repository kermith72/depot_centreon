...
$fatpacked{"apps/monitoring/dynatrace/restapi/custom/api.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_MONITORING_DYNATRACE_RESTAPI_CUSTOM_API';
  #
...
$fatpacked{"apps/monitoring/dynatrace/restapi/mode/problems.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_MONITORING_DYNATRACE_RESTAPI_MODE_PROBLEMS';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/monitoring/dynatrace/restapi/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_MONITORING_DYNATRACE_RESTAPI_PLUGIN';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
