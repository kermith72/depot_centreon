...
$fatpacked{"apps/graylog/restapi/custom/api.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_GRAYLOG_RESTAPI_CUSTOM_API';
  #
...
$fatpacked{"apps/graylog/restapi/mode/notifications.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_GRAYLOG_RESTAPI_MODE_NOTIFICATIONS';
  #
  ## Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/graylog/restapi/mode/query.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_GRAYLOG_RESTAPI_MODE_QUERY';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/graylog/restapi/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_GRAYLOG_RESTAPI_PLUGIN';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
