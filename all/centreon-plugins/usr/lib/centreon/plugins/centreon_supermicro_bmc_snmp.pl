...
$fatpacked{"hardware/server/supermicro/bmc/snmp/mode/hardware.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_SERVER_SUPERMICRO_BMC_SNMP_MODE_HARDWARE';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"hardware/server/supermicro/bmc/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_SERVER_SUPERMICRO_BMC_SNMP_PLUGIN';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
