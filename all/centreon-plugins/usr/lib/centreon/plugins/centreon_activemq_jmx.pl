...
$fatpacked{"apps/mq/activemq/jmx/mode/brokers.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_MQ_ACTIVEMQ_JMX_MODE_BROKERS';
  #
...
$fatpacked{"apps/mq/activemq/jmx/mode/listbrokers.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_MQ_ACTIVEMQ_JMX_MODE_LISTBROKERS';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/mq/activemq/jmx/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_MQ_ACTIVEMQ_JMX_PLUGIN';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
