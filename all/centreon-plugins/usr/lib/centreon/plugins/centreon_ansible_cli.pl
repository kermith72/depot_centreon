...
$fatpacked{"apps/automation/ansible/cli/custom/cli.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_AUTOMATION_ANSIBLE_CLI_CUSTOM_CLI';
  #
...
$fatpacked{"apps/automation/ansible/cli/mode/discovery.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_AUTOMATION_ANSIBLE_CLI_MODE_DISCOVERY';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/automation/ansible/cli/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_AUTOMATION_ANSIBLE_CLI_PLUGIN';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
