...
$fatpacked{"hardware/devices/hms/ewon/snmp/mode/listtags.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_DEVICES_HMS_EWON_SNMP_MODE_LISTTAGS';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"hardware/devices/hms/ewon/snmp/mode/tags.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_DEVICES_HMS_EWON_SNMP_MODE_TAGS';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"hardware/devices/hms/ewon/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_DEVICES_HMS_EWON_SNMP_PLUGIN';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
