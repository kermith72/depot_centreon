...
$fatpacked{"cloud/microsoft/office365/onedrive/mode/siteusage.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_MICROSOFT_OFFICE365_ONEDRIVE_MODE_SITEUSAGE';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/microsoft/office365/onedrive/mode/usersactivity.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_MICROSOFT_OFFICE365_ONEDRIVE_MODE_USERSACTIVITY';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
