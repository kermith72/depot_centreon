...
$fatpacked{"apps/monitoring/openmetrics/mode/scrapemetrics.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_MONITORING_OPENMETRICS_MODE_SCRAPEMETRICS';
  #
...
$fatpacked{"apps/monitoring/openmetrics/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_MONITORING_OPENMETRICS_PLUGIN';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
