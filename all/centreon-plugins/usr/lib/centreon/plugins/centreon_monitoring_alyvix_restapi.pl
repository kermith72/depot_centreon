...
$fatpacked{"apps/monitoring/alyvix/restapi/custom/api.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_MONITORING_ALYVIX_RESTAPI_CUSTOM_API';
  #
...
$fatpacked{"apps/monitoring/alyvix/restapi/mode/listtestcases.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_MONITORING_ALYVIX_RESTAPI_MODE_LISTTESTCASES';
  #
  ## Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/monitoring/alyvix/restapi/mode/testcases.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_MONITORING_ALYVIX_RESTAPI_MODE_TESTCASES';
  #
  ## Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/monitoring/alyvix/restapi/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_MONITORING_ALYVIX_RESTAPI_PLUGIN';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
