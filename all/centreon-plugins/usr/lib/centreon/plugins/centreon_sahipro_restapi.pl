...
$fatpacked{"apps/sahipro/restapi/mode/scenario.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_SAHIPRO_RESTAPI_MODE_SCENARIO';
  #
...
$fatpacked{"apps/sahipro/restapi/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_SAHIPRO_RESTAPI_PLUGIN';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
