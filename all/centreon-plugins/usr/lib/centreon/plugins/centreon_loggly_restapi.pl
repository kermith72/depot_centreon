...
$fatpacked{"apps/monitoring/loggly/restapi/custom/api.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_MONITORING_LOGGLY_RESTAPI_CUSTOM_API';
  #
...
$fatpacked{"apps/monitoring/loggly/restapi/mode/events.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_MONITORING_LOGGLY_RESTAPI_MODE_EVENTS';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/monitoring/loggly/restapi/mode/fields.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_MONITORING_LOGGLY_RESTAPI_MODE_FIELDS';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/monitoring/loggly/restapi/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_MONITORING_LOGGLY_RESTAPI_PLUGIN';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
