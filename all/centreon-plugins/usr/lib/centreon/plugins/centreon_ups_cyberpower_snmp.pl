...
$fatpacked{"centreon/common/cps/ups/snmp/mode/batterystatus.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CENTREON_COMMON_CPS_UPS_SNMP_MODE_BATTERYSTATUS';
  #
...
$fatpacked{"centreon/common/cps/ups/snmp/mode/inputlines.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CENTREON_COMMON_CPS_UPS_SNMP_MODE_INPUTLINES';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"centreon/common/cps/ups/snmp/mode/outputlines.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CENTREON_COMMON_CPS_UPS_SNMP_MODE_OUTPUTLINES';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"hardware/ups/cyberpower/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'HARDWARE_UPS_CYBERPOWER_SNMP_PLUGIN';
  #
  # Centreon is a full-fledged industry-strength solution that meets
  # the needs in IT infrastructure and application monitoring for
  # service performance.
