...
$fatpacked{"apps/slack/restapi/mode/listservices.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_SLACK_RESTAPI_MODE_LISTSERVICES';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/slack/restapi/mode/services.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_SLACK_RESTAPI_MODE_SERVICES';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
