...
$fatpacked{"apps/microsoft/dhcp/snmp/mode/listsubnets.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_MICROSOFT_DHCP_SNMP_MODE_LISTSUBNETS';
  #
...
$fatpacked{"apps/microsoft/dhcp/snmp/mode/subnets.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_MICROSOFT_DHCP_SNMP_MODE_SUBNETS';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/microsoft/dhcp/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_MICROSOFT_DHCP_SNMP_PLUGIN';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
