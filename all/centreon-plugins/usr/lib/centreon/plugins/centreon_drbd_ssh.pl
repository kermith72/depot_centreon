...
$fatpacked{"apps/drbd/local/mode/resources.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_DRBD_LOCAL_MODE_RESOURCES';
  #
...
$fatpacked{"apps/drbd/local/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_DRBD_LOCAL_PLUGIN';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
