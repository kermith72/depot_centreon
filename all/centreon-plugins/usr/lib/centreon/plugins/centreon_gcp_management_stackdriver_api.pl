...
$fatpacked{"cloud/google/gcp/management/stackdriver/mode/getmetrics.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_GOOGLE_GCP_MANAGEMENT_STACKDRIVER_MODE_GETMETRICS';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/google/gcp/management/stackdriver/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_GOOGLE_GCP_MANAGEMENT_STACKDRIVER_PLUGIN';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
