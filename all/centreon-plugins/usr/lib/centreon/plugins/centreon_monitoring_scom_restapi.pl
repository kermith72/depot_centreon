...
$fatpacked{"apps/monitoring/scom/restapi/custom/api.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_MONITORING_SCOM_RESTAPI_CUSTOM_API';
  #
...
$fatpacked{"apps/monitoring/scom/restapi/mode/alerts.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_MONITORING_SCOM_RESTAPI_MODE_ALERTS';
  #
...
$fatpacked{"apps/monitoring/scom/restapi/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_MONITORING_SCOM_RESTAPI_PLUGIN';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
