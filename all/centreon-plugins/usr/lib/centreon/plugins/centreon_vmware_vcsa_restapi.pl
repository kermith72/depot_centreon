...
$fatpacked{"apps/vmware/vcsa/restapi/custom/api.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_VMWARE_VCSA_RESTAPI_CUSTOM_API';
  #
...
$fatpacked{"apps/vmware/vcsa/restapi/mode/health.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_VMWARE_VCSA_RESTAPI_MODE_HEALTH';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/vmware/vcsa/restapi/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_VMWARE_VCSA_RESTAPI_PLUGIN';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
