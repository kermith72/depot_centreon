...
$fatpacked{"apps/voip/3cx/restapi/custom/api.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_VOIP_3CX_RESTAPI_CUSTOM_API';
  #
...
$fatpacked{"apps/voip/3cx/restapi/mode/extension.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_VOIP_3CX_RESTAPI_MODE_EXTENSION';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/voip/3cx/restapi/mode/system.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_VOIP_3CX_RESTAPI_MODE_SYSTEM';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/voip/3cx/restapi/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_VOIP_3CX_RESTAPI_PLUGIN';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
