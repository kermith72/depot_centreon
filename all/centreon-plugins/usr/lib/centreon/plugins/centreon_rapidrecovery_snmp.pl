...
$fatpacked{"apps/backup/rapidrecovery/snmp/mode/agent.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_BACKUP_RAPIDRECOVERY_SNMP_MODE_AGENT';
  #
...
$fatpacked{"apps/backup/rapidrecovery/snmp/mode/repository.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_BACKUP_RAPIDRECOVERY_SNMP_MODE_REPOSITORY';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/backup/rapidrecovery/snmp/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_BACKUP_RAPIDRECOVERY_SNMP_PLUGIN';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
