...
$fatpacked{"apps/google/workspace/custom/api.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_GOOGLE_WORKSPACE_CUSTOM_API';
  #
...
$fatpacked{"apps/google/workspace/mode/listservices.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_GOOGLE_WORKSPACE_MODE_LISTSERVICES';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/google/workspace/mode/services.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_GOOGLE_WORKSPACE_MODE_SERVICES';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/google/workspace/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_GOOGLE_WORKSPACE_PLUGIN';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
