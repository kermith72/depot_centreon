...
$fatpacked{"cloud/google/gcp/storage/mode/bucket.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_GOOGLE_GCP_STORAGE_MODE_BUCKET';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/google/gcp/storage/mode/discovery.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_GOOGLE_GCP_STORAGE_MODE_DISCOVERY';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"cloud/google/gcp/storage/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'CLOUD_GOOGLE_GCP_STORAGE_PLUGIN';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
