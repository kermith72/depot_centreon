...
$fatpacked{"apps/cisco/ssms/restapi/custom/api.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_CISCO_SSMS_RESTAPI_CUSTOM_API';
  #
...
$fatpacked{"apps/cisco/ssms/restapi/mode/alerts.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_CISCO_SSMS_RESTAPI_MODE_ALERTS';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/cisco/ssms/restapi/mode/licenses.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_CISCO_SSMS_RESTAPI_MODE_LICENSES';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
...
$fatpacked{"apps/cisco/ssms/restapi/plugin.pm"} = '#line '.(1+__LINE__).' "'.__FILE__."\"\n".<<'APPS_CISCO_SSMS_RESTAPI_PLUGIN';
  #
  # Copyright 2021 Centreon (http://www.centreon.com/)
  #
  # Centreon is a full-fledged industry-strength solution that meets
